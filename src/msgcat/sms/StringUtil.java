...
public class StringUtil {
    ...
    public static CommonSms analyseSMS(String str, int index) {
        ...
        String datestring = s[len - 2].substring(0, s[len - 2].length() - 3).replace(',', ' ');// 短信猫时间格式09/09/09
                                                                                               // 20:18:01+32
        Date date = null;
        try {
    ...
    public static List<CommonSms> analyseArraySMS(String str) {
        ...
        for (int i = 1; i < messages.length; i++) {
            ...
            if (t.length > 5) {
                ...
                SimpleDateFormat df = new SimpleDateFormat("yy/MM/dd hh:mm:ss");
                String datestring = t[4].substring(t[4].indexOf('"') + 1) + " " + t[5].substring(0, t[5].indexOf('"'));// 短信猫时间格式09/09/09
                                                                                                                       // 20:18:01+32
                Date date = null;
                try {
                    date = df.parse(datestring);
